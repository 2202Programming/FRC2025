...
import frc.lib2202.subsystem.hid.TMJoystick;
...
public final class BindingsCompetition {
    ...
    private static void DriverBinding(HID_Xbox_Subsystem dc) {
        ...
        Joystick.trigger(TMJoystick.ButtonType.Trigger).whileTrue(new RobotCentricDrive(drivetrain, dc));
        Joystick.trigger(TMJoystick.ButtonType.LeftOne).onTrue(new AllianceAwareGyroReset(true));
    }
