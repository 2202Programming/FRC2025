...
public final class BindingsCompetition {
    ...
    static void OperatorBindings(HID_Subsystem dc) {
        ...
        if (generic_opr instanceof CommandXboxController) {
            ...
            Trigger NotGI = GICalibrate.negate();
            ...
            NotGI.and(operator.povLeft()).onTrue(new InstantCommand(() -> {
            ...
            if (RobotContainer.getSubsystemOrNull(GroundIntake.class) != null) {
                ...
                NotGI.and(operator.b()).whileTrue(new PlaceSequence("coral"));
            ...
            if (RobotContainer.getSubsystemOrNull(Elevator_Subsystem.class) != null) {
                 ...
                 * NotGI.and(operator.povLeft()).onTrue(); //mid
                 * operator.povDown().onTrue(); //low
                 * NotGI.and(operator.povRight()).onTrue(); //intake height
                 */
            }
            if (RobotContainer.getSubsystemOrNull(EndEffector_Subsystem.class) != null) {
                ...
                // they're viable -er
                NotGI.and(operator.rightBumper()).whileTrue(new EndEffectorPercent(-.3, "rightBumper")); // reverse
            ...
            GICalibrate.and(operator.povRight()).whileTrue(new TopArmVel(30.0));
