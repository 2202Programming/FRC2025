...
public class RobotSpec_CompBotAlpha2025 implements IRobotSpec {
  // Subsystems and other hardware on 2024 Robot rev Alpha
  final SubsystemConfig ssconfig = new SubsystemConfig("CompBotAlpha2025", "032381BF")
  ...
  public RobotSpec_CompBotAlpha2025() {
