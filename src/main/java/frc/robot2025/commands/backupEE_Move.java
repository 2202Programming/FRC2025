...
public class backupEE_Move extends Command {
  /** Creates a new ClimberSetPos. */
  final backupEE endEffector;
  double RPM;
  public backupEE_Move(double RPM) {
    endEffector = RobotContainer.getSubsystem(backupEE.class);
    this.RPM = RPM;
