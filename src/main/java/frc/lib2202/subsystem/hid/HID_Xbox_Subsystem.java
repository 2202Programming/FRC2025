...
public class HID_Xbox_Subsystem extends SubsystemBase {
  ...
  private final TMJoystickController joystick;
  ...
  public HID_Xbox_Subsystem(final double velExpo, final double rotExpo, final double deadzone) {
    ...
    joystick = (TMJoystickController) registerController(Id.Joystick, new TMJoystickController(Id.Joystick.value));
  ...
  public TMJoystickController Joystick() {return joystick; }
